# [Raging-sea](https://raging-sea.kyledlong.com)
...
```bash
git clone https://github.com/KD-Long/raging-sea.git
```
...
4. Automatic deployment --> ~/public_html/_sub_raging-sea/

5. Configured sub domain [raging-sea.kyledlong.com](https://raging-sea.kyledlong.com) to point to "_sub_raging-sea/" folder